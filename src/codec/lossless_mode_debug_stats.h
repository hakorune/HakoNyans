...
struct LosslessModeDebugStats {
    ...
    uint64_t filter_lo_mode7;
    uint64_t filter_lo_mode7_saved_bytes_sum;
    uint64_t filter_lo_mode8;
    uint64_t filter_lo_mode8_saved_bytes_sum;
    uint64_t filter_lo_mode8_candidates;
    uint64_t filter_lo_mode8_reject_gate;
    uint64_t filter_lo_mode8_reject_best;
    uint64_t filter_lo_mode8_wrapped_bytes_sum;
    uint64_t filter_lo_mode8_ctx_legacy_sum;
    uint64_t filter_lo_mode8_ctx_delta_sum;
    uint64_t filter_lo_mode8_ctx_lz_sum;
    ...
    uint64_t filter_lo_mode7_candidates;
    uint64_t filter_lo_mode7_reject_gate;
    uint64_t filter_lo_mode7_reject_best;
    ...
    uint64_t filter_lo_mode7_wrapped_bytes_sum;
    uint64_t filter_lo_mode7_legacy_bytes_sum;
    uint64_t filter_lo_mode7_shared_ctx_sum;
    ...
    uint64_t filter_lo_mode7_eval_ns;
    uint64_t filter_lo_mode8_eval_ns;
    ...
    uint64_t natural_row_mode2_lz_optparse_enabled;
    uint64_t natural_row_mode2_lz_optparse_fallback_count;
    uint64_t natural_row_mode2_lz_optparse_fallback_memcap;
    uint64_t natural_row_mode2_lz_optparse_fallback_allocfail;
    uint64_t natural_row_mode2_lz_optparse_fallback_unreachable;
    uint64_t natural_row_mode2_lz_optparse_dp_positions_sum;
    uint64_t natural_row_mode2_lz_optparse_lit_edges_sum;
    uint64_t natural_row_mode2_lz_optparse_match_edges_sum;
    uint64_t natural_row_mode2_lz_optparse_tokens_lit_sum;
    uint64_t natural_row_mode2_lz_optparse_tokens_match_sum;
    uint64_t natural_row_mode2_lz_optparse_shorter_than_longest_sum;
    uint64_t natural_row_mode2_lz_optparse_probe_accept;
    uint64_t natural_row_mode2_lz_optparse_probe_reject;
    uint64_t natural_row_mode2_lz_optparse_adopt;
    uint64_t natural_row_mode2_lz_optparse_reject_small_gain;
